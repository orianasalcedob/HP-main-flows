...
import '../support/component.js';
  ...
  describe('Casos HP', function() {
    ...
    cy.visit('https://instant-ink-platinum-dev.tropos-rnd.com/?oobe=true', {
    ...
    //Login con cuenta ya creada que tiene informacion cargada

        cy.get('#username').click().type('testing29@account.com')
        cy.get('#user-name-form-submit').click()
        cy.get('#password').click().type('Testing1')
